...
export function EmptyState() {
  ...
  return (
    <div className="absolute inset-0 flex flex-col items-center justify-center bg-background p-4 h-full w-full">
      <div className="flex flex-col items-center p-12 rounded-2xl border-2 border-dashed max-w-[400px] text-center bg-panel relative transition-colors border-border">
        <>
          ...
          <p className="text-sm leading-relaxed m-0 mb-6 text-muted-foreground">
            Upload a CSV file containing your database relationships to
            auto-generate a directed graph.
          </p>
          <label
            htmlFor="csv-upload"
